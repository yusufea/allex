...
const TABS = [
    { id: "Overview",      labelKey: "ironDeficiency.tabs.overview" },
    { id: "Test Contents", labelKey: "ironDeficiency.tabs.test_contents" },
    { id: "Instructions",  labelKey: "ironDeficiency.tabs.instructions" },
    { id: "Your Result",   labelKey: "ironDeficiency.tabs.your_result" },
]

const BANNER_BADGES = [
    { labelKey: "ironDeficiency.badges.fingerstick",      icon: "/fingerstick-blood.png" },
    { labelKey: "ironDeficiency.badges.accuracy",         icon: "/accuracy.png" },
    { labelKey: "ironDeficiency.badges.clinically_tested",icon: "/clinically_tested.png" },
    { labelKey: "ironDeficiency.badges.result_time",      icon: "/results-in-5-mins.png" },
]

const RESULT_KEYS = [
    { id: "normal",   color: "bg-green-600 hover:bg-green-700",   labelKey: "ironDeficiency.your_result.normal_label",   titleKey: "ironDeficiency.your_result.normal_title",   bodyKey: "ironDeficiency.your_result.normal_body" },
    { id: "abnormal", color: "bg-red-600 hover:bg-red-700",       labelKey: "ironDeficiency.your_result.abnormal_label", titleKey: "ironDeficiency.your_result.abnormal_title", bodyKey: "ironDeficiency.your_result.abnormal_body" },
    { id: "invalid",  color: "bg-slate-500 hover:bg-slate-600",   labelKey: "ironDeficiency.your_result.invalid_label",  titleKey: "ironDeficiency.your_result.invalid_title",  bodyKey: "ironDeficiency.your_result.invalid_body" },
]

const INSTRUCTION_SLIDES = Array.from({ length: 11 }, (_, i) => `/iron-deficiency-instructions/Slide${i + 1}.PNG`)

export default function IronDeficiencyPage() {
    ...
    const symptoms = [
        t("ironDeficiency.overview.symptom_1"),
        t("ironDeficiency.overview.symptom_2"),
        t("ironDeficiency.overview.symptom_3"),
        t("ironDeficiency.overview.symptom_4"),
        t("ironDeficiency.overview.symptom_5"),
        t("ironDeficiency.overview.symptom_6"),
        t("ironDeficiency.overview.symptom_7"),
        t("ironDeficiency.overview.symptom_8"),
    ]
                ...
                <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
                    <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
                        ...
                        <div className="w-full lg:w-1/2 flex justify-center">
                            <Image
                                src="/iron-deficiency-main.png"
                                alt={t("ironDeficiency.title")}
                                width={520}
                                height={420}
                ...
                <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
                        ...
                        <div className="flex flex-col lg:flex-row gap-12">
                            ...
                            <div className="w-full lg:w-1/2 flex flex-col gap-4">
                                <h2 className="font-garet font-black text-2xl text-slate-900 uppercase">
                                    {t("ironDeficiency.overview.title")}
                                </h2>
                                <video controls className="w-full rounded-xl border border-slate-200 shadow-sm">
                                    <source src="https://silex-videos.s3.eu-west-2.amazonaws.com/iron-deficiency-overview.mp4" type="video/mp4" />
                                </video>
                            </div>

                            <div className="w-full lg:w-1/2 flex flex-col gap-4">
                                <h2 className="font-garet font-black text-2xl text-slate-900 uppercase">
                                    {t("ironDeficiency.overview.symptoms_title")}
                                </h2>
                                <p className="font-inter text-slate-500 text-sm">
                                    {t("ironDeficiency.overview.symptoms_intro")}
                                </p>
                    ...
                    {activeTab === "Test Contents" && (
                        <div className="flex flex-col lg:flex-row gap-12 items-start">
                            ...
                            <div className="w-full lg:w-3/5 flex justify-center">
                                <Image
                                    src="/iron-deficiency-test-contents.png"
                                    alt={t("ironDeficiency.tabs.test_contents")}
                                    width={480}
                                    height={380}
                            ...
                            <div className="w-full lg:w-2/5 flex flex-col gap-4 items-center">
                                <h2 className="font-garet font-black text-2xl text-slate-900 uppercase self-start">
                                    {t("ironDeficiency.test_contents.view_360")}
                                </h2>
                                <iframe
                                    title={t("ironDeficiency.test_contents.view_360")}
                                    allowFullScreen
                                    style={{ border: "none" }}
                                    width="100%"
                                    height="420"
                                    src="https://www.pacdora.com/share?filter_url=psm0d9ym6b"
                    ...
                    {activeTab === "Instructions" && (
                        <div className="flex flex-col gap-8 max-w-3xl mx-auto">
                            ...
                            <div className="flex gap-8">
                                {[
                                    { mode: "video",  labelKey: "ironDeficiency.instructions.video_label" },
                                    { mode: "slides", labelKey: "ironDeficiency.instructions.slides_label" },
                                ].map(({ mode, labelKey }) => (
                            ...
                            {instructionMode === "video" && (
                                <video controls poster="/iron-deficiency-instructions-thumbnail.jpg" className="w-full rounded-xl border border-slate-200 shadow-sm">
                                    <source src="https://silex-videos.s3.eu-west-2.amazonaws.com/iron-deficiency-instructions.mp4" type="video/mp4" />
                                </video>
                            )}
                            ...
                            {instructionMode === "slides" && (
                                <div className="flex flex-col gap-4 items-center">
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        >
                                            {t("ironDeficiency.instructions.prev")}
                                        </button>
                                        ...
                                        >
                                            {t("ironDeficiency.instructions.next")}
                                        </button>
                                    </div>
                    ...
                    {activeTab === "Your Result" && (
                        <div className="flex flex-col gap-8 items-center">
                            <h2 className="font-garet font-black text-2xl text-slate-900 uppercase">
                                {t("ironDeficiency.your_result.title")}
                            </h2>
            ...
            <section className="w-full py-12 md:py-20 bg-slate-50 border-t border-slate-200">
                <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
                    <h2 className="font-garet font-black text-3xl md:text-4xl text-slate-900 mb-10">
                        {t("ironDeficiency.faqs.title")}
                    </h2>

                    <Accordion type="single" collapsible className="w-full flex flex-col gap-3">
                        {[
                            { id: "q1", q: "ironDeficiency.faqs.q1_q", a: "ironDeficiency.faqs.q1_a" },
                            { id: "q2", q: "ironDeficiency.faqs.q2_q", a: "ironDeficiency.faqs.q2_a" },
                            { id: "q3", q: "ironDeficiency.faqs.q3_q", a: "ironDeficiency.faqs.q3_a" },
                            { id: "q4", q: "ironDeficiency.faqs.q4_q", a: "ironDeficiency.faqs.q4_a" },
                            { id: "q5", q: "ironDeficiency.faqs.q5_q", a: "ironDeficiency.faqs.q5_a" },
                        ].map(({ id, q, a }) => (
